...
OUTPATH = "/home/stefan/tmp/ortho02/out_v2/"
...
infile = os.path.join(OUTPATH, "ortho2002rgb.vrt")
outfile = os.path.join(OUTPATH, "ortho2002rgb_5m.tif")
