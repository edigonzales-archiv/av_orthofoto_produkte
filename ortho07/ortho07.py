...
BASEPATH = "/home/stefan/tmp/ortho07/"
OUTPATH = "/home/stefan/tmp/ortho07/out/"

shp = ogr.Open(os.path.join(BASEPATH,"ortho07tindex.shp"))
...
outfile = os.path.join(OUTPATH, "ortho2007rgb.vrt")
